...
function restoreSession() {
	...
	SessionStore.setBrowserState(stateString);
...
async function saveSession(name) {
	...
	let overwriteFile = PathUtils.join(sessionDir, name);
	await IOUtils.writeUTF8(overwriteFile, JSON.stringify(gStateObject));
	document.getElementById("stateStringContainer").setAttribute("stateString", encodeURIComponent(JSON.stringify(gStateObject)));
	return;
}
